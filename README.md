...
- [x] an artifact (animated GIF, html5 animation, etc) that your code produced (e.g, ["gganimate.gif"](ArtifactExamples/gganimate.gif))
- [x] a LICENCE file indicating that your code can be used and modified (with attribution) after the contest
